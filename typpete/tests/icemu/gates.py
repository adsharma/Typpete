...
class CD4001B(NOR):
    IO_MAPPING = [["A", "B", "J"], ["C", "D", "K"], ["G", "H", "M"], ["E", "F", "L"]]
    INPUT_PINS = list(
        chain(
            IO_MAPPING[0][:2], IO_MAPPING[1][:2], IO_MAPPING[2][:2], IO_MAPPING[3][:2]
        )
    )
