...
# ----- functions -----
def asctime(
    t: Union[Tuple[int, int, int, int, int, int, int, int, int], struct_time] = None
) -> str:
    ...  # return current time
...
def mktime(
    t: Union[Tuple[int, int, int, int, int, int, int, int, int], struct_time]
) -> float:
    ...
...
def strptime(string: str, format: str = None) -> struct_time:
    ...
